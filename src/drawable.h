...
protected:
    ...
    GLuint bufInfluencer; //A Vertex Buffer Object that we will use to store mesh vertices (ivec2s)
    GLuint bufWeights; //A Vertex Buffer Object that we will use to store mesh vertices (vec2s)
